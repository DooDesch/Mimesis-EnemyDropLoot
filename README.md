...
2. **Rename Everything:**
   - Rename the folder from `Boilerplate` to your mod name
   - Search and replace `Boilerplate` with `YourModName` in all files:
     - `Boilerplate.csproj` → `YourModName.csproj`
